...
func (m *Manager) executeHome(ctx context.Context, providers []string, req cliproxyexecutor.Request, opts cliproxyexecutor.Options, countTokens bool, optionalTracker ...*routeAttemptTracker) (cliproxyexecutor.Response, error) {
	...
	for {
		response, errExecute := m.executeHomeOnceWithTracker(ctx, providers, req, opts, countTokens, maxRetryCredentials, &homeRetryLimit, attempt, tracker)
		if errExecute == nil {
			return response, nil
		}
...
func (m *Manager) executeHomeOnce(ctx context.Context, providers []string, req cliproxyexecutor.Request, opts cliproxyexecutor.Options, countTokens bool, maxRetryCredentials int, homeRetryLimit *int, retryRounds ...int) (cliproxyexecutor.Response, error) {
	...
	return m.executeHomeOnceWithTracker(ctx, providers, req, opts, countTokens, maxRetryCredentials, homeRetryLimit, retryRound, nil)
}

func (m *Manager) executeHomeOnceWithTracker(ctx context.Context, providers []string, req cliproxyexecutor.Request, opts cliproxyexecutor.Options, countTokens bool, maxRetryCredentials int, homeRetryLimit *int, retryRound int, tracker *routeAttemptTracker) (cliproxyexecutor.Response, error) {
